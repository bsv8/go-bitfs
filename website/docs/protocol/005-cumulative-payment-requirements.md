...
Therefore, in BitFS the seller's behavior is:
...
2. Atomically save the in-progress request together with the exact signed 003 indexed by its `PaymentAuthorizationID`, then deliver 004.
