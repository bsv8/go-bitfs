...
For the specific close messages and the unsettled boundaries of BitFS, see [Fee Pool Unconditional Close Specification](006-unconditional-pool-close-spec.md).
