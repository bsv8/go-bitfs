...
4. End-to-end tests cover the full 001–008 lifecycle with the test acting as the application: all intermediate states are held in test variables and passed explicitly into every call.
