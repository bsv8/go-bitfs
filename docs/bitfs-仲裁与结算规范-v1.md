...
> **历史兼容文档，不作为新施工依据。** 本文的 `HashGetTicket`、`session_id`、服务端记录、`proposal_id`、仲裁最终金额和签名域属于旧 V1 设计。新设计以 [001-报价凭证规范](001-报价凭证规范.md) 至 [006-费用池无条件关闭规范](006-费用池无条件关闭规范.md) 为准；尤其 V1 新关闭路径不在池内定义仲裁金额。
